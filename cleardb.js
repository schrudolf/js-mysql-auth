...
async function createUsers(con){
    ...
    const users = "CREATE TABLE IF NOT EXISTS users (id INT(11) NOT NULL AUTO_INCREMENT,email VARCHAR(50) NOT NULL, password VARCHAR(100) NOT NULL,ipAddress VARCHAR(30) NULL,registered DATETIME DEFAULT CURRENT_TIMESTAMP,lastlogin DATETIME DEFAULT null,PRIMARY KEY (id))";
